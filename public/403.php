...
<head>
    ...
    <title>403 — Accès interdit | <?php echo APP_NAME; ?></title>
...
<body style="background:var(--sc-bg);display:flex;align-items:center;justify-content:center;min-height:100vh;">
    <div class="text-center" style="max-width:420px;padding:32px;">
        ...
        <h1 style="font-size:64px;font-weight:800;color:#ef4444;margin:0;font-family:'Space Grotesk',sans-serif;">403</h1>
        <h2 style="font-size:20px;font-weight:600;margin:8px 0 12px;">Accès interdit</h2>
        <p class="text-muted" style="font-size:14px;">Vous n'avez pas les permissions nécessaires pour accéder à cette page.</p>
